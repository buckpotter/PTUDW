<x-layout>
  ...
  <div class="bg-white mt-4">
    ...
    <canvas id="potential-users"></canvas>
    <!-- <canvas id="bus-comp-rating"></canvas> -->
  ...
  <script>
    ...
    const potentialUsersEl = document.getElementById('potential-users');
    // const busCompRatingEl = document.getElementById('bus-comp-rating');
    ...
    // Top 5 nhà xe có đánh giá cao nhất horizantal bar chart
    // data = [];
    // labels = [];
    // <?php
        // foreach ($busCompRating as $bcr) {
        //   echo "data.push({$bcr->rating});";
        //   echo "labels.push('{$bcr->Ten_NX}');";
        // }
        // 
        ?>
    // new Chart(busCompRatingEl, {
    //   type: 'bar',
    //   data: {
    //     labels: labels,
    //     datasets: [{
    //       data: data,
    //       label: "Top 5 nhà xe có đánh giá cao nhất",
    //       borderWidth: 3,
    //       fill: true,
